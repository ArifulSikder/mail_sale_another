            ...
            <div class="my-1 d-flex justify-content-between">
                ...
                <form action="">
                    <div class="form-group d-flex">
                        <input class="form-control" type="search" placeholder="Search By Coupon Name" name="search" value="<?php echo e($search); ?>">
                        ...
                        <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e($coupon->product->name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($coupon->start_date)); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($coupon->end_date)); ?></td>
                                    <td><?php echo e($coupon->coupon_discount); ?> %</td>
                                    
                                    <td><span
                                            class="badge badge-<?php echo e($coupon->active_status == 0 ? 'danger': 'success'); ?>"><?php echo e($coupon->active_status == 0 ? 'Inactive': 'Active'); ?>
                                    ...
                                    <td>    
                                        <button type="button" 
                                            ...
                                            <div class="text-center dropdown-menu bg-light-blue">
                                                <?php if($coupon->active_status == 0): ?>
                                                   <a href="<?php echo e(route('update-coupon-status', ['id' => $coupon->id , 'status' => $coupon->active_status ])); ?>" class="btn btn-success btn-sm btn-block"><i class="fas fa-angle-double-right"></i> Active</a> 
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('update-coupon-status', ['id' => $coupon->id , 'status' => $coupon->active_status ])); ?>" class="btn btn-danger btn-sm btn-block"><i class="fas fa-angle-double-right"></i> Inactive</a> 
                                                <?php endif; ?>
                                                <button type="button"
                                                    data-id="<?php echo e($coupon->id); ?>"
                                                    data-coupon_name="<?php echo e($coupon->coupon_name); ?>"
                                                    data-coupon_code="<?php echo e($coupon->coupon_code); ?>"
                                                    data-product_id="<?php echo e($coupon->product_id); ?>"
                                                    data-start_date="<?php echo e($coupon->start_date); ?>"
                                                    data-end_date="<?php echo e($coupon->end_date); ?>"
                                                    data-limit="<?php echo e($coupon->limit); ?>"
                                                    data-coupon_discount="<?php echo e($coupon->coupon_discount); ?>"
                                                    data-active_status="<?php echo e($coupon->active_status); ?>"
                                                    class="btn btn-success btn-sm editData btn-block">
                                                    <i class="fas fa-edit"></i> Edit
                                                </button>

                                                <a href="<?php echo e(route('delete-coupon',['id' => $coupon->id] )); ?>"
...
<script>
    $(document).ready(function () {
            ...
            $("#formData").submit(function (e) { 
              ...
              $.ajax({
                  type: "POST",
                  url: "<?php echo e(route('store-coupon')); ?>",
                  contentType: false,
                  processData: false,
                  headers: {
          ...
          $("#editData").submit(function (e) { 
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('update-coupon')); ?>",
                    contentType: false,
                    processData: false,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mail_sale_another\resources\views/backend/coupon/indexCoupon.blade.php ENDPATH**/ ?>