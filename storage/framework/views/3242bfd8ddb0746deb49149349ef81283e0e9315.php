                      ...
                      <div class="col-lg-12">
                          <div class="invoice-inner clearfix">
                                              ...
                                              <div>
                                                ...
                                                <form id="formData">
                                                  ...
                                                  <select class="form-control select2 status" name="status"
                                                    ...
                                                    <option value="Shipped" <?php if($order->status == 'Shipped'): echo 'selected'; endif; ?>>Shipped</option>
                              ...
                              <div class="invoice-btn-section clearfix d-print-none">
                                  ...
                                  <a id="invoice_download_btn" href="<?php echo e(route('download-invoice-pdf', ['id' => $order->id])); ?>" class="btn btn-lg btn-download btn-theme">
  ...
  <script>
    $(document).ready(function () {
      $("#formData").submit(function (e) { 
              ...
              $.ajax({
                  type: "POST",
                  url: "<?php echo e(route('update-invoice')); ?>",
                  contentType: false,
                  processData: false,
                  headers: {
