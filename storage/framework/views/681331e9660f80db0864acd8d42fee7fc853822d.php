...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Product Description(<?php echo e($product->name); ?>)</h1>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                                ...
                                1;
                            ?>
                            <?php $__currentLoopData = $productDescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th scope="row"><?php echo e($serials++); ?></th>
                                    <td><?php echo Str::words($detail->content, 20, '....'); ?>

                                        <?php if(Str::of($detail->content)->wordCount() > 20): ?>
                                           <a  class="editdes" style="cursor: pointer;" data-description="<?php echo e($detail ->content); ?>">
                                               See More
                                           </a>
                                       <?php endif; ?>
                                    </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu text-center bg-light-blue">
                                                ...
                                                <a data-toggle="modal" data-target="#editNew"
                                                    ...
                                                    data-content="<?php echo e($detail->content); ?>"
                                                    data-active_status="<?php echo e($detail->active_status); ?>"> <i class="fas fa-edit"></i> Edit</a>

                                                <a href="<?php echo e(url('delete-Description/'. $detail->id)); ?>"
                    ...
                    <div class="float-right my-2">
                        <?php echo e($productDescriptions->links()); ?>
...
<script>
    $(document).ready(function () {
            ...
            $("#formData").submit(function (e) { 
              ...
              $.ajax({
                  type: "POST",
                  url: "<?php echo e(route('add-product-description')); ?>",
                  contentType: false,
                  processData: false,
                  headers: {
          ...
          $("#editData").submit(function (e) { 
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('update-product-description')); ?>",
                    contentType: false,
                    processData: false,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mail_sale_another\resources\views/backend/product/description/indexDescription.blade.php ENDPATH**/ ?>