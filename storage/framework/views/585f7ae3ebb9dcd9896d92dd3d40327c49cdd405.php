...
<div class="content-wrapper" x-data="{category:  null }">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><?php echo e($category->category_title); ?></h1>
                ...
                <div class="col-12" id="accordion">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="card card-primary card-outline">
                                    <div class="card-header row" >
                                        <div class="col-6">
                                            <h4 class="card-title w-100 text-primary">
                                                <a class="" data-toggle="collapse" href="#<?php echo e(str_replace(' ', '_', $faq->faqCategory->category_title)); ?><?php echo e($faq->id); ?>"><?php echo e($loop->iteration); ?>. <?php echo e($faq->question); ?></a>
                                            </h4>
                                        </div>
                                        <div class="col-6 ">
                                            <div class="row text-center">
                                                <div class="col-4"></div>
                                                <div class="col-2">
                                                    <button type="button" data-id="<?php echo e($faq->id); ?>"
                                                        data-question="<?php echo e($faq->question); ?>"
                                                        data-answer="<?php echo e($faq->answer); ?>"
                                                        data-active_status="<?php echo e($faq->active_status); ?>"
                                                        class="btn btn-success btn-sm edit_ques">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                </div>
                                                <div class="col-2">
                                                    <a href="<?php echo e(route('delete-faq-question', ['id' => $faq->id])); ?>"
                                                        id="delete" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                                </div>
                                                <div class="col-2">
                                                   <?php if($faq->active_status == 0): ?>
                                                        <a href="<?php echo e(route('update-question-status', ['id' => $faq->id , 'status' => $faq->active_status ])); ?>" class=""><span class="badge badge-danger">Inactivated</span></a> 
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('update-question-status', ['id' => $faq->id , 'status' => $faq->active_status ])); ?>"><span class="badge badge-success">Activated</span></a>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="col-2">
                                                    <a class="" data-toggle="collapse" href="#<?php echo e(str_replace(' ', '_', $faq->faqCategory->category_title)); ?><?php echo e($faq->id); ?>"><i class="fas fa-chevron-down"></i></a>
                                                </div>
                                    ...
                                    <div id="<?php echo e(str_replace(' ', '_', $faq->faqCategory->category_title)); ?><?php echo e($faq->id); ?>" class="collapse" data-parent="#accordion">
                                        <div class="card-body">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select  class="form-control select2" name="category_id" id="category_id"
                                ...
                                <option selected  value="<?php echo e($category->id); ?>"><?php echo e($category->category_title); ?></option>
                            </select>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#formData").submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('store-faq-question')); ?>",
                contentType: false,
                processData: false,
                data: formData,
                headers: {
        ...
        $("#updateData").submit(function (e) { 
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('update-faq-question')); ?>",
                contentType: false,
                processData: false,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mail_sale_another\resources\views/backend/homepage/faq/faqQuestions.blade.php ENDPATH**/ ?>