    ...
    <section class="about-account-area">
        <div class="container">
            <div class="wrapper content">
                ...
                <div>
                    <img class="pb-5" src="<?php echo e(asset('frontend')); ?>/assets/images/all-images/google.png" alt="Gmail_image">
                </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\altab_mail_sell\resources\views/frontend/pricing.blade.php ENDPATH**/ ?>