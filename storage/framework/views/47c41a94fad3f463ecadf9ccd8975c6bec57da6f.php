                            ...
                            <div class='form-row row'>
                                <div class='col-xs-12 form-group required'>
                                    <label class='control-label'>Name on Card</label> <input class='form-control'
                                        size='4' name="card_name" type='text'>
                                </div>
                            </div>
                            ...
                            <div class='form-row row'>
                                <div class='col-xs-12 col-md-4 form-group cvc required'>
                                    <label class='control-label'>CVC</label> <input autocomplete='off'
                                        class='form-control card-cvc' name="card_cvc" placeholder='ex. 311'
                                        size='4' type='text'>
                                </div>
                                ...
                                <div class='col-xs-12 col-md-4 form-group expiration required'>
                                    <label class='control-label'>Expiration Year</label> <input
                                        class='form-control card-expiry-year' name="expiry_year" placeholder='YYYY'
                                        size='4' type='text'>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now
                                        ($<?php echo e($selling_price * $product_quantity); ?>)</button>
                                </div>
                            </div>
...
<?php /**PATH C:\laragon\www\altab_mail_sell\resources\views/frontend/stripe.blade.php ENDPATH**/ ?>