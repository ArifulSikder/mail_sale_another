...
<?php $__env->startSection('title', 'Set Email'); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                ?> 
                                <?php $__currentLoopData = $email_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <th><?php echo e($serials++); ?></th>
                                        <td><?php echo e($data->mailer); ?></td>
                                        <td><?php echo e($data->host); ?></td>
                                        <td><?php echo e($data->port); ?></td>
                                        <td><?php echo e($data->username); ?></td>
                                        <td><?php echo e($data->password); ?></td>
                                        <td><?php echo e($data->encription); ?></td>
                                        <td><?php echo e($data->address); ?></td>
                                        <td><?php echo e($data->name); ?></td>
                                        <td><span
                                                class="badge badge-<?php echo e($data->active_status == 0 ? 'danger': 'success'); ?>"><?php echo e($data->active_status == 0 ? 'Inactive': 'Active'); ?></span>
                                        </td>
                                        <td>    
                                            <button type="button" 
                                                ...
                                                <div class="text-center dropdown-menu bg-light-blue">
                                                    ...
                                                    <a href="<?php echo e(route('update-email-status', ['id' => $data->id , 'status' => $data->active_status ])); ?>" class="btn btn-success btn-sm btn-block"><i class="fas fa-angle-double-right"></i> Active</a> 
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('update-email-status', ['id' => $data->id , 'status' => $data->active_status ])); ?>" class="btn btn-danger btn-sm btn-block"><i class="fas fa-angle-double-right"></i> Inactive</a> 
                                                    <?php endif; ?>
                                                    <button type="button" data-email="<?php echo e($data); ?>"
                                                        class="btn btn-success btn-sm editData btn-block">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </button>
                                                    <a href="<?php echo e(route('delete-email', ['id' => $data->id])); ?>"
...
<script>
    $(document).ready(function () {
            ...
            $("#formData").submit(function (e) { 
              ...
              $.ajax({
                  type: "POST",
                  url: "<?php echo e(route('store-email-data')); ?>",
                  contentType: false,
                  processData: false,
                  headers: {
          ...
          $("#editData").submit(function (e) { 
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('update-email-data')); ?>",
                    contentType: false,
                    processData: false,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mail_sale_another\resources\views/backend/env/emailIndex.blade.php ENDPATH**/ ?>