            ...
            <div class="box">
                <div class="row">
                    <div class="col-md-4">
                        <div class="box-item text-center">
                            <div class="box-image mb-3">
                                <img src="<?php echo e(asset('frontend')); ?>/assets/images/home-page/s1.png" alt="">
                            </div>
                            <div class="box-text">
                                <h5>SAFETY</h5>
                    ...
                    <div class="col-md-4">
                        <div class="box-item text-center">
                            <div class="box-image mb-3">
                                <img src="<?php echo e(asset('frontend')); ?>/assets/images/home-page/s2.png" alt="">
                            </div>
                            <div class="box-text">
                                <h5>LONGEVITY</h5>
        ...
        <div class="team-wrapper">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="team-item text-center">
                        <div class="member-image">
                            <img src="<?php echo e(asset('frontend')); ?>/assets/images/home-page/team1.webp" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="team-item text-center">
                        <div class="member-image">
                            <img src="<?php echo e(asset('frontend')); ?>/assets/images/home-page/team3.webp" alt="">
                            <div class="text-inner">
                                <div class="member-info">
                                    <h5>JOSEPH K. RODRIGUEZ</h5>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\altab_mail_sell\resources\views/frontend/index.blade.php ENDPATH**/ ?>