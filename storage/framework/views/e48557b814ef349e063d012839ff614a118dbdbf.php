            ...
            <div class="faq-content">
              ...
              <?php $__empty_1 = true; $__currentLoopData = $faq_cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  ...
                  <div class="col-sm-12 col-md-8 col-lg-8 mt-4">
                    <div class="faq-all">
                      <div class="accordion" id="accordionExample<?php echo e($faq_cat->id); ?>">
                          <?php $__empty_2 = true; $__currentLoopData = $faq_cat->question->where('active_status', 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ques): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <div class="accordion-item custom-item">
                              <h2 class="accordion-header" id="headingOne<?php echo e($ques->id); ?>">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne<?php echo e($ques->id); ?>" aria-expanded="true" aria-controls="collapseOne<?php echo e($ques->id); ?>">
                                  <?php echo e($ques->question); ?>

                                </button>
                              </h2>
                              <div id="collapseOne<?php echo e($ques->id); ?>" class="accordion-collapse collapse" aria-labelledby="headingOne<?php echo e($ques->id); ?>" data-bs-parent="#accordionExample<?php echo e($ques->category_id); ?>">
