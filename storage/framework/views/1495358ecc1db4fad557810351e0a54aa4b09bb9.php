            ...
            <div class="my-1 d-flex justify-content-between">
                ...
                <form action="">
                    <div class="form-group d-flex">
                        <input class="form-control" type="search" placeholder="Search By Seller Name" name="search" value="<?php echo e($search); ?>">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><span
                                            class="badge badge-<?php echo e($seller->active_status == 0 ? 'danger': 'success'); ?>"><?php echo e($seller->active_status == 0 ? 'Inactive': 'Active'); ?></span>
                                    </td>
                                    <td><?php echo e($seller->created_at->toFormateDate()); ?></td>
                                    <td>    
                                        <button type="button" 
                                            ...
                                            <div class="text-center dropdown-menu bg-light-blue">
                                                <?php if($seller->active_status == 0): ?>
                                                   <a href="<?php echo e(route('update-seller-status', ['id' => $seller->id , 'status' => $seller->active_status ])); ?>" class="btn btn-success btn-sm btn-block"><i class="fas fa-angle-double-right"></i> Active</a> 
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('update-seller-status', ['id' => $seller->id , 'status' => $seller->active_status ])); ?>" class="btn btn-danger btn-sm btn-block"><i class="fas fa-angle-double-right"></i> Inactive</a> 
                                                <?php endif; ?>
                                                <button type="button"
                                                    data-id="<?php echo e($seller->id); ?>"
                                                    data-seller_name="<?php echo e($seller->seller_name); ?>"
                                                    data-address="<?php echo e($seller->address); ?>"
                                                    data-phone="<?php echo e($seller->phone); ?>"
                                                    data-active_status="<?php echo e($seller->active_status); ?>"
...
<script>
    $(document).ready(function () {
            ...
            $("#formData").submit(function (e) { 
              ...
              $.ajax({
                  type: "POST",
                  url: "<?php echo e(route('store-seller')); ?>",
                  contentType: false,
                  processData: false,
                  headers: {
          ...
          $("#editData").submit(function (e) { 
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('update-seller')); ?>",
                    contentType: false,
                    processData: false,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mail_sale_another\resources\views/backend/seller/indexSeller.blade.php ENDPATH**/ ?>