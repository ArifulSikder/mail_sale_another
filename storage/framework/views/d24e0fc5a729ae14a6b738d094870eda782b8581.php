    ...
    <div class="container">
      <div class="product-details-content wrapper">
        <div class="row">
          <div class="col-lg-5">
            <div class="insta">
              <img class="img-fluid" src="<?php echo e(asset($product->thumbnail)); ?>" alt="logo">
            </div>
          </div>
          <div class="col-lg-7">
            <div class="details">
              ...
              <div class="service">
                <?php if($product && count($product->details) > 0 && $product->details->where('active_status', 1)->first()): ?>
              ...
              <div class="items d-flex text-center">
                ...
                <p><?php echo e($setting != null ? $setting->email : '#'); ?></p>
              </div>
              <div class="items d-flex text-center">
                ...
                <p><?php echo e($setting != null ? $setting->skype : '#'); ?></p>
              </div>
              <div class="items d-flex text-center">
                ...
                <p><?php echo e($setting != null ? $setting->telegram : '#'); ?></p>
              </div>
              <div class="items d-flex text-center">
                ...
                <p><?php echo e($setting != null ? $setting->whatsapp : '#'); ?></p>
              </div>
              <div class="quantity">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-10">
                                  <div class="card-body">
                                    ...
                                    <h5 class="card-title"><?php echo e($review->name); ?> – <?php echo e($review->date); ?></h5>
                                    <p class="card-text"><?php echo e($review->customer_review); ?></p>
                                  </div>
...
<script>
  $(document).ready(function () {
          $("#formData").submit(function (e) { 
              ...
              $.ajax({
                  type: "POST",
                  url: "<?php echo e(route('store-customer-review')); ?>",
                  contentType: false,
                  processData: false,
                  headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mail_sale_another\resources\views/frontend/product-details.blade.php ENDPATH**/ ?>