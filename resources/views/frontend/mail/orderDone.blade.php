                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-sm-6 invoice-id">
                                        <div class="info">
                                            ...
                                            <p class="color-white mb-1">Invoice Number <span>{{ "#A".$order_data['order_id'] + 100 }}</span></p>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="invoice-number mb-30">
                                            ...
                                            <h2 class="name mb-10">{{ $order_data['order']['f_name'] }} {{ $order_data['order']['l_name'] }} </h2>
                                            <p class="invo-addr-1">
                                                {{ $order_data['order']['company_name'] }}<br/>
                                                {{ $order_data['order']['email'] }} <br/>
                                                {{ $order_data['order']['phone'] }} <br/>
                                        ...
                                        <tbody>
                                          ...
                                          @endforeach
                                            <tr class="tr2">
                                              ...
                                              <td class="text-end">${{ $order_data['order']['total_price'] }} <br/>
                                              </td>
                                            </tr>
                                            <tr class="tr2">
                                              <td></td>
                                              ...
                                              <td class="f-w-600 text-end active-color">${{ $order_data['order']['total_price'] }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="invoice-bottom">
                                <div class="row">
                                    <div class="col-lg-6 col-md-8 col-sm-7">
                                        ...
                                        <div>
                                            <label for="" >Status: </label> <span class="badge badge-warning"> {{ $order_data['order']['status'] }}</span>
                                        </div>
