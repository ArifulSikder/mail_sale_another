...
@section('sideSection')
    ...
    <section class="privacy-policy-area">
        <div class="container">
            <div class="parivacy wrapper">
                <h4><b>Privacy Policy for Pvaeshop</b></h4>
                <p>At Pvaeshop, accessible from 
                    <a href="./index.html">https://www.pvaeshop.com/</a> , one
                    of our main priorities is the privacy of our visitors. This Privacy Policy document contains types
                    of information that is collected and recorded by Pvaeshop and how we use it.</p>
                <p>If you have additional questions or require more information about our Privacy Policy, do not
                    hesitate to contact us.</p>
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in Pvaeshop. This policy is not
                ...
                <p>The personal information that you are asked to provide, and the reasons why you are asked to provide
                    it, will be made clear to you at the point we ask you to provide your personal information.</p <p>If
                ...
                <p>When you register for an Account, we may ask for your contact information, including items such as
                    name, company name, address, email address, and telephone number.</p <h4><b>How we use your
                    information</b></h4>
                ...
                <h4><b>Log Files</b></h4>
                <p>Pvaeshop follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <h4><b>Cookies and Web Beacons</b></h4>
                <p>Like any other website, Pvaeshop uses ‘cookies’. These cookies are used to store information
                ...
                <h4><b>Advertising Partners Privacy Policies</b></h4>
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on Pvaeshop, which are sent
                ...
                <p>Note that Pvaeshop has no access to or control over these cookies that are used by third-party
                    advertisers.</p>
                <h4><b>Third Party Privacy Policies</b></h4>
                <p>Pvaeshop’s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
                ...
                <h4><b>CCPA Privacy Rights (Do Not Sell My Personal Information)</b></h4>
                ...
                <p>Pvaeshop does not knowingly collect any Personal Identifiable Information from children under the age
