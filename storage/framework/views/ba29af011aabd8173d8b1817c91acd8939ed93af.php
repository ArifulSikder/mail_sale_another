            ...
            <div class="d-flex justify-content-between my-1">
                ...
                <form action="" class="col-4">
                    <div class="form-group d-flex">
                        <input class="form-control" type="search" placeholder="Search By SubCategory Name" name="search" value="<?php echo e($search); ?>">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu text-center bg-light-blue">
                                                ...
                                                <a href="<?php echo e(url('subcategory-description/'. $category->id)); ?>"
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mail_sale_another\resources\views/backend/product/sub_category/index.blade.php ENDPATH**/ ?>