                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            ">
                                ...
                                <a href="<?php echo e(url('my-account/dashboard')); ?>" class="nav-link tab-button active text-uppercase">Dashboard</a>
                                ...
                                <a href="<?php echo e(url('my-account/logout')); ?>" class="nav-link tab-button text-uppercase" >Logout</a>
                            </div>
                        </div>
