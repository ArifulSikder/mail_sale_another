    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <ul class="mt-2 nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <!-- Settings -->
                <li class="nav-item <?php echo e(request()->is(['add-business-policy', 'show-business-policy', 'sms-templete', 'set-email', 'edit-business-policy*', 'default-sms']) ? 'menu-open' : ''); ?>">
                    <a href="#" class="nav-link <?php echo e(request()->is(['add-business-policy', 'show-business-policy', 'sms-templete', 'set-email', 'edit-business-policy*', 'default-sms']) ? 'active' : ''); ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('show-business-policy')); ?>" class="nav-link <?php echo e(request()->is(['show-business-policy', 'edit-business-policy*']) ? 'active' : ''); ?>">
                                <i class="far fa-circle nav-icon"></i>
